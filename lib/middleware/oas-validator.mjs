...
export default (oasDoc => {
  return function OASValidator(req, res, next) {
    ...
    config.logger.info("Requested method-url pair: " + method + " - " + req.url);
    ...
    config.logger.debug("OASValidator  -res.locals.requestedSpecPath: " + res.locals.requestedSpecPath);
    checkRequestData(oasDoc, requestedSpecPath, method, res, req, next);
  };
});
//# sourceMappingURL=oas-validator.mjs.map